...
const Hero = () => {
  ...
  return (
    <>
      ...
      <div 
        className="relative py-6 md:py-16 bg-cover bg-center bg-no-repeat min-h-screen flex flex-col items-center justify-center px-4 md:px-8"
      ...
      >
        ...
        <div className="absolute inset-0 top-1/3 transform -translate-y-1/3 w-full h-auto flex justify-center z-0 opacity-30 pointer-events-none">
          <Globe className="w-full max-w-[12rem] md:max-w-[36rem] animate-spin-slow" />
        </div>

        <div className="relative z-10 p-4 md:p-8 rounded-lg text-center w-full max-w-4xl mx-auto">
          <h2 className="text-xl md:text-5xl font-light mb-2 md:mb-4 text-white font-serif italic animate-fade-in-up">
            Welcome to
          </h2>
          <h1 className="text-2xl md:text-7xl font-bold mb-3 md:mb-6 text-white font-serif tracking-wide animate-fade-in-up animation-delay-200">
            Vlan Business Technologies
          </h1>
          <p className="text-base md:text-3xl text-gray-200 mb-4 md:mb-8 font-sans leading-relaxed animate-fade-in-up animation-delay-400">
            Your one-stop IT solutions provider and security systems
          </p>
          
          <div className="flex flex-col sm:flex-row justify-center space-y-3 sm:space-y-0 sm:space-x-4 mb-6 md:mb-12 animate-fade-in-up animation-delay-600">
            <a
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 animate-fade-in-up animation-delay-800">
            <BoxReveal boxColor={"#5046e6"} duration={0.5}>
              <div className="text-white p-3 md:p-6 rounded-lg bg-opacity-20 bg-white backdrop-filter backdrop-blur-sm h-full flex flex-col">
                <h3 className="text-xl md:text-4xl font-semibold font-serif tracking-wide mb-2 md:mb-4">
                  Vpos Point of Sale System
                </h3>
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="item-1">
                    <AccordionTrigger className="text-white text-sm md:text-base">Our Services</AccordionTrigger>
                    <AccordionContent>
                      <ul className="straight-line-list text-xs md:text-base font-sans text-left space-y-1 md:space-y-2">
            ...
            <BoxReveal boxColor={"#FF4500"} duration={0.5}>
              <div className="text-white p-3 md:p-6 rounded-lg bg-opacity-20 bg-white backdrop-filter backdrop-blur-sm h-full flex flex-col">
                ...
                <p className="text-sm md:text-xl font-sans mb-2 md:mb-4">
                  Minimum entry grade C- and above in KCSE
                </p>
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="item-1">
                    <AccordionTrigger className="text-white text-sm md:text-base">Diploma Programs</AccordionTrigger>
                    <AccordionContent>
                      <ul className="straight-line-list list-disc list-inside space-y-1 text-xs md:text-sm">
                  ...
                  <AccordionItem value="item-2">
                    <AccordionTrigger className="text-white text-sm md:text-base">Professional Certifications</AccordionTrigger>
                    <AccordionContent>
                      <ul className="straight-line-list list-disc list-inside space-y-1 text-xs md:text-sm">
                      ...
                      <p className="font-semibold mt-2 mb-1 text-xs md:text-sm">KASNEB (ATD & CPA) New Syllabus</p>
                      <p className="font-semibold mt-2 mb-1 text-xs md:text-sm">Accounting Packages</p>
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="item-3">
                    <AccordionTrigger className="text-white text-sm md:text-base">Language Courses</AccordionTrigger>
                    <AccordionContent>
                      <ul className="straight-line-list list-disc list-inside space-y-1 text-xs md:text-sm">
                        <li>English</li>
                        <li>French</li>
        ...
        {isModalOpen && (
          <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-75 p-4">
            <div className="bg-white p-4 md:p-8 rounded-lg shadow-2xl w-full max-w-sm md:max-w-2xl text-center">
              ...
              <p className="text-lg md:text-3xl font-semibold text-green-600 mb-3 md:mb-6 font-sans">
                From <span className="text-red-500">Ksh 50,000</span> — a small investment for big rewards!
              </p>
              <button
                onClick={closeModal}
                className="bg-blue-600 text-white px-4 py-2 md:px-6 md:py-3 rounded-full hover:bg-blue-700 transition duration-300 text-sm md:text-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
                Close
              </button>
            </div>
